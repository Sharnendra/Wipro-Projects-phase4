...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute("employeeBean") EmployeeBean employeeBean, 
			BindingResult result) {
		System.out.println("Name = "+employeeBean.getName()+"addess "+employeeBean.getAddress());
